...
Blockly.Blocks['read_untilsoftwareserial'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("ReadString")
        .appendField(
            ...
            "softwareSerial")
        .appendField("until")
        .appendField(new Blockly.FieldDropdown([["Salto de linea (LF)","\\n"], ["Retorno de carro (CR)","\\r"]]), "char");
    this.setInputsInline(true);
    this.setOutput(true, "Text");
    this.setColour(180);
 this.setTooltip("Software Serial Read String Function until end character");
 this.setHelpUrl("");
  }
};

Blockly.Blocks['readuntilsoftwareserial'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("ReadString")
        .appendField(
...
Blockly.Blocks['softwareserial_settimeout'] = {
  init: function() {
    this.appendDummyInput()
    ...
    this.setNextStatement(true, null);
    this.setColour(180);
 this.setTooltip("Software Serial Set TimeOut");
 this.setHelpUrl("https://www.arduino.cc/reference/en/language/functions/communication/serial/settimeout/");
  }
};