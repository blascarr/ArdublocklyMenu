...
Blockly.Arduino['base_map'] = function(block) {
  ...
  var valueBmin = Blockly.Arduino.valueToCode(
      block, 'BMIN', Blockly.Arduino.ORDER_NONE) || '0';
  var valueBmax = Blockly.Arduino.valueToCode(
      block, 'BMAX', Blockly.Arduino.ORDER_NONE) || '0';
  var valueDmin = Blockly.Arduino.valueToCode(
      block, 'DMIN', Blockly.Arduino.ORDER_NONE) || '0';
  var valueDmax = Blockly.Arduino.valueToCode(
      block, 'DMAX', Blockly.Arduino.ORDER_ATOMIC) || '0';

  var code = 'map(' + valueNum + ','+ valueBmin +', '+ valueBmax +', '+ valueDmin +' , ' + valueDmax + ')';
