...
Blockly.Arduino['madgwick_setup'] = function(block) {
  ...
  Blockly.Arduino.addDeclaration(filter_instance,'Madgwick '+filter_instance+';',false);
  var setupCode = filter_instance+'.begin('+madgwick_freq+');';
  Blockly.Arduino.addSetup('microsPerReading', 'microsPerReading = 1000 / 25;', true);
...
Blockly.Arduino['imu_setup'] = function(block) {
	...
	Blockly.Arduino.addSetup('microsPerReading', 'microsPerReading = 1000 / 25;', false);
