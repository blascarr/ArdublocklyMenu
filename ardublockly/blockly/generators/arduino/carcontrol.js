...
Blockly.Arduino['smartcar_definepins'] = function(block) {
  ...
  Blockly.Arduino.addVariable(value_m11,'int M11='+value_m11+';',true);
  Blockly.Arduino.addVariable(value_m12,'int M12='+value_m12+';',true);
  Blockly.Arduino.addVariable(value_m21,'int M21='+value_m21+';',true);
  Blockly.Arduino.addVariable(value_m22,'int M22='+value_m22+';',true);
  ...
  var setupcar = '\tpinMode(M11,OUTPUT);\n'+
   ...
   '\tpinMode(M21,OUTPUT);\n'+
   '\tpinMode(M22,OUTPUT);\n';
  Blockly.Arduino.addDeclaration('smartcarDefine', MPins+'\n'+movecar );
