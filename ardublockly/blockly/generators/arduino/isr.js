...
Blockly.Arduino['attach_interruptpin'] = function(block) {
  ...
  var code = 'attachInterrupt(digitalPinToInterrupt('+int_pin+'),'+value_isr+', '+int_mode+');\n';
  Blockly.Arduino.addSetup('INT_'+int_pin,code);
  return code;
};
...
Blockly.Arduino['volatile_block'] = function(block) {
  ...
  var code = 'volatile '+value_code;
  Blockly.Arduino.addDeclaration('VOLATILE'+value_code,code);
